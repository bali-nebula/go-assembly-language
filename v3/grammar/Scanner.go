...
const (
	...
	comment_    = "(?:--[^" + control_ + "]*)"
	delimiter_  = "(?:WITH ARGUMENTS|WITH 3 ARGUMENTS|WITH 2 ARGUMENTS|WITH 1 ARGUMENT|VARIABLE|TO|SKIP|SEND|SAVE|RESULT|PUSH|PULL|ON NONE|ON FALSE|ON EMPTY|NOTE|MESSAGE|LOAD|LITERAL|JUMP TO|HANDLER|EXCEPTION|DROP|DRAFT|CONTRACT|CONSTANT|CALL|ARGUMENT|:)"
